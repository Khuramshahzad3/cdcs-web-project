  ...
  return (
    <header>
      ...
      >
        ...
        {/* Desktop Navbar */}
        <div className="">
          <div className={`lg:flex lg:flex-row lg:items-center md:w-[470px] lg:w-[810px] h-[76px] ${scrolled ? "bg-white " : "bg-[rgba(206,249,254,0.21)]"} rounded-[39px] gap-10 p-5 hidden lg:gap-10 lg:px-10 transition-colors duration-300`}>
            <ul className="flex flex-row items-center gap-5 lg:gap-10 font-semibold">
              <li>
                <Link

                  to="/"
                  className={`text-lg ${isActive("/") ? "w-[77px] h-[44px] rounded-[25px] bg-gradient-to-r from-[#144F30] to-[#03A651] p-3" : ""} ${scrolled ? "text-black" : "text-white"}`}
                >
                  Home
                </Link>
              </li>
              <li>
                <Link
                  ...
                  to="/mission"
                  className={`text-lg ${isActive("/mission") ? "w-[77px] h-[44px] rounded-[25px] bg-gradient-to-r from-[#144F30] to-[#03A651] p-3" : ""} ${scrolled ? "text-black" : "text-white"}`}
                >
                  Mission
                </Link>
              </li>
              <li className="">
                <Link
                  ...
                  to="/services"
                  className={`text-lg flex items-center gap-2 ${isActive("/services") ? "w-[87px] h-[44px] rounded-[25px] bg-gradient-to-r from-[#144F30] to-[#03A651] p-3" : ""} ${scrolled ? "text-black" : "text-white"}`}
                >
                  Services
                </Link>
              </li>
              <li>
                <Link
                  ...
                  to="/our-strategy"
                  className={`text-lg ${isActive("/our-strategy") ? "w-[77px] h-[44px] rounded-[25px] bg-gradient-to-r from-[#144F30] to-[#03A651] p-3" : ""} ${scrolled ? "text-black" : "text-white"}`}
                >
                  Our Strategy
                </Link>
              </li>
              <li>
                <Link
                  ...
                  to="/outsourcing"
                  className={`text-lg ${isActive("/outsourcing") ? "w-[77px] h-[44px] rounded-[25px] bg-gradient-to-r from-[#144F30] to-[#03A651] p-3" : ""} ${scrolled ? "text-black" : "text-white"}`}
                >
                  Outsourcing
                </Link>
              </li>
              <li>
                <Link
                  ...
                  to="/aboutus"
                  className={`text-lg ${isActive("/aboutus") ? "w-[77px] h-[44px] rounded-[25px] bg-gradient-to-r from-[#144F30] to-[#03A651] p-3" : ""} ${scrolled ? "text-black" : "text-white"}`}
                >
                  About
                </Link>
              </li>
        ...
        >
          ...
          >
            <ul className="flex flex-col text-white  gap-10 lg:gap-10 font-semibold ">
              ...
              <li>
                <Link to="/mission" className={`text-lg ${isActive("/mission") ? "w-[77px] h-[44px] rounded-[25px] bg-gradient-to-r from-[#144F30] to-[#03A651]  p-3" : ""}`} onClick={()=>topandclose()}>
                  Mission
                </Link>
              </li>
              <li className="">
                <Link to="/services" className={`text-lg flex items-center gap-2 ${isActive("/services") ? "w-[87px] h-[44px] rounded-[25px] bg-gradient-to-r from-[#144F30] to-[#03A651]  p-3 " : ""}`} onClick={()=>topandclose()}>
                  Services
                  {/* <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="7"
              ...
              <li>
                <Link to="/our-strategy" className={`text-lg ${isActive("/our-strategy") ? "w-[77px] h-[44px] rounded-[25px] bg-gradient-to-r from-[#144F30] to-[#03A651] p-3 " : ""}`} onClick={()=>topandclose()}>
                  Our Strategy
                </Link>
              </li>
              <li>
