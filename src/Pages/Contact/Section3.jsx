          ...
          <div className=" ">
            <div className="p-2 mt-40 md:mt-32 flex flex-col md:flex-row md:gap-20 md:items-start items-center    md:mb-20 xl:gap-28">
              ...
              <div className="mt-10 md:mt-0 lg:mt-10 xl:mt-20 flex flex-col items-center md:items-start gap-3">
                ...
                <p className="text-[#03A651] font-bold font-Poppins text-xs mt-[-15px] cursor-pointer">Click The Service To Explore</p>
                <ul className="max-w-[665px] max-h-[444px]  text-[#210F03] font-Poppins lg:text-[22px] font-light  md:text-start list-disc flex flex-col gap-3 xl:text-2xl xl:gap-7 max-md:ml-7 text-sm max-md:mb-80 ">
