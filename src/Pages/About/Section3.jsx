    ...
    <section>
      <div className="bg-Artboardlarge   ">
        <div className="max-w-[1440px] mx-auto  lg:px-10  xl:px-24 p-2  md:p-10 md:py-10">
          <div className=" ">
            ...
            <div className="p-2 flex flex-col items-center relative">
              ...
              <div className="max-w-[1110px] max-h-[440px] flex items-center justify-center flex-col  px-5 h-[370px] xs:h-[450px] bg-[#F9FDFF] rounded-[16px]  shadow-[0px_4px_20px_0px_rgba(0,0,0,0.12)] xs:top-[12rem] absolute top-40 sm:top-[18rem] md:top-[50.417vw] w-[83.333vw] md:h-[240px] lg:h-[320px] xl:h-[420px] xl:top-[575.796px] ">
                {/*  */}
                <p className="max-w-[1095px]   text-[#210F03] text-center font-Poppins xl:text-[30px] lg:text-2xl font-light  xl:leading-[45px] text-sm xs:text-base">
        ...
        <div className="max-w-[1440px] mx-auto  lg:px-6  xl:px-12 max-md:p-2  md:p-5 ">
          <div className=" ">
            <div className="p-2 mt-96 md:mt-48 flex flex-col md:flex-row md:gap-20 md:items-start items-center  justify-center  lg:mt-56  xl:mt-72 md:mb-20 xl:gap-28">
              {/* images */}
              ...
              <div className="mt-10 md:mt-0 lg:mt-10 xl:mt-20 flex flex-col items-center md:items-start gap-3  max-md:mb-10">
                ...
                <span className="font-semibold">The CDCS will provide the following services to its clients:  </span>
