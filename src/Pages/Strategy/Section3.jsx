        ...
        <div className="max-w-[1440px] mx-auto  lg:px-6  xl:px-12 max-md:p-2  md:p-5 ">
          <div className=" ">
            <div className="p-2 mt-40 md:mt-32 flex flex-col md:flex-row md:gap-20 md:items-start items-center    md:mb-20 xl:gap-28">
              {/* images */}
              <div className="flex flex-col items-center justify-center mt-20  md:flex-col relative  max-md:gap-3 md:mt-32  lg:mt-52 xl:mt-60  gap-[51px] lg:ml-5 xl:gap-[60px] lg:gap-[50px] md:gap-7">
              ...
              <div className="mt-10 md:mt-0 lg:mt-10 xl:mt-20 flex flex-col items-center md:items-start gap-3 h-full mb-[35rem] xs:mb-[32rem] sm:mb-[20rem] md:mb-0">
