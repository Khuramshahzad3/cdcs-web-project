          ...
          <div className=" ">
            <div className="p-2 flex flex-col md:flex-row md:gap-20 md:items-start items-center    md:mb-20 xl:gap-28">
              ...
              <div className="flex flex-col items-center justify-center   md:flex-col relative  max-md:gap-3 md:top-10   gap-[51px] lg:ml-5 xl:gap-[60px] lg:gap-[50px] md:gap-7">
                ...
                <div className="max-w-[439.052px] max-h-[367.6px]  rounded-[21px_21px_11px_11px] bg-[rgba(217,217,217,0.39)] w-[50%] h-[50%] md:w-[100%]" data-aos="fade-right" >
              ...
              <div className="mt-10 md:mt-0  flex flex-col items-center md:items-start gap-3 h-full mb-[35rem] xs:mb-[32rem] sm:mb-[20rem] md:mb-0">
                ...
                <ul className=" max-h-[444px]  text-[#210F03] font-Poppins lg:text-[18px] font-light lg:leading-[30px] xl:leading-[37px]   md:text-start list-disc flex flex-col gap-10   max-md:ml-7 text-sm  sm:text-base  md:leading-[30px]   md:gap-[5vw]  lg:gap-[5vw] xl:gap-[130px] md:mt-5  max-w-[647px]">
